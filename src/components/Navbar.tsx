...
import shopping from './SVGs/shopping-cartsvg.svg'
    ...
    <NavbarBs sticky="top" className="bg-white shadow-sm mb-3">
        <Container >
            ...
            className="rounded-circle">
                ...
                {{color: "white", width: "1.5rem", position: "absolute", height: "1.5rem", bottom: -2, right: 0, transform: "translate(25%, 25%"}}>2</div>
            </Button>
        </Container>
    </NavbarBs>
  )
